...
<head>
  ...
  <style>
    ...
    *,*::before,*::after{box-sizing:border-box}
    ...
    body{margin:0;font-family:'Inter',system-ui,-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;background:#000;color:#eee;-webkit-font-smoothing:antialiased;text-rendering:optimizeLegibility}
    ...
    /* ---------- Header ---------- */
    header{position:fixed;top:40px;left:0;width:100%;z-index:100;transition:background .3s,top .3s}
    ...
    .hero-video{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;filter:brightness(.42);z-index:-2}
    /* Image fallback if video fails */
    .hero::before{content:"";position:absolute;inset:0;background:url('images/hero.jpg') center/cover no-repeat,radial-gradient(60% 60% at 50% 40%,#1a1a1a,#000);filter:brightness(.42);z-index:-3}
    .hero-content{z-index:2;max-width:900px;padding:0 20px}
    .hero h1{font-size:72px;line-height:1.05;font-weight:700;letter-spacing:-.02em;margin-bottom:16px}
    .hero h2{font-size:28px;font-weight:400;color:#ccc;margin-bottom:20px}
    .hero p{font-size:20px;line-height:1.6;color:#ddd;margin-bottom:0}
    ...
    .display{font-size:46px;font-weight:700;margin:0 0 16px}
    ...
    .btn{display:inline-block;padding:14px 32px;background:#fff;color:#000;border-radius:40px;text-decoration:none;font-weight:700;font-size:15px}
    ...
    .site-footer a{display:block;color:#aaa;margin:6px 0}
